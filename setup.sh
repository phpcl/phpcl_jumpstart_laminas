...
docker exec jumpstart_laminas /bin/bash -c "php /srv/jumpstart/phpcl_jumpstart_laminas/laminas_project/composer.phar install --working-dir=/srv/jumpstart/phpcl_jumpstart_laminas/laminas_project"
docker exec jumpstart_laminas /bin/bash -c "mysql < /srv/jumpstart/phpcl_jumpstart_laminas/sample_data/restore.sql"
docker exec jumpstart_laminas /bin/bash -c "mysql < /srv/jumpstart/phpcl_jumpstart_laminas/sample_data/jumpstart.sql"
docker exec jumpstart_laminas /bin/bash -c "ln -s /srv/jumpstart/phpcl_jumpstart_laminas/laminas_project/public /srv/www/laminas"
